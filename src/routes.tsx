...
export const routes: RouteObject[] = [
  ...
  },
  {
    ...
    loader: async ({ params }) => {
      const lastAPIFetchDate = getlastFetchDateFromStorage(
        'lastPodcastDetailFetch'
      )
      const podcastDetailFromStorage = getPodcastDetailFromStorage(
        params.podcastId as string
      )

      if (
        oneDaySinceLastFetch(lastAPIFetchDate) ||
        podcastDetailFromStorage === null
      ) {
  ...
  },
  {
    ...
    loader: async ({ params }) => {
      ...
      if (podcastDetailFromStorage !== null) {
        return podcastDetailFromStorage
      }
